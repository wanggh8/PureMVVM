...
public final class SPUtils {
    ...
    private SPUtils(final String spName) {
        sp = com.kunminx.architecture.utils.Utils.getApp().getSharedPreferences(spName, Context.MODE_PRIVATE);
    }

    private SPUtils(final String spName, final int mode) {
        sp = com.kunminx.architecture.utils.Utils.getApp().getSharedPreferences(spName, mode);
    }
